...
R0 <- c(1.5,2.5,4) 
Rt1 <- c(0.9,1.1,1.3)    # Rt at first NPI introduction
Rt2 <- R0   # Rt at lifting
timing1 <- 10      # introduction of NPIs
timing2 <- 365   # lifting of NPIs - default of 365 for no vaccine, code calculates timing 2 when elderly population vaccinated
...
### Save output ################################################################
saveRDS(out_combine, "output/2_mitigated_mv_scenarios.rds")
