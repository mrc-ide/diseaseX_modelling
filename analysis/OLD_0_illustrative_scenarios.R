...
baseline_scenarios <- expand.grid(R0 = R0,
                                  Rt_change = Rt_change,  ## replace this with the NPI scenarios in my notes
...
baseline_scenarios$efficacy_infection_v1 <- 0.35   # proportion of the population vaccinated
