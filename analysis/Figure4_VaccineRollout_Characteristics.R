...
#### Figure 4A & 4B - Delay to Access

# Figure 4A - Empirical Delays to Access for COVID-19 
...
## Figure 4B - Varying Specific Development Time in Realistic Ways
...
ggplot(data = subset(model_outputs2, detection_timing == "Intermediate" & NPI_int %in% c(4, 7, 8))) +
  geom_line(aes(x = specific_vaccine_start, 
...
# Figure 4D - BPSV Vaccination Rates
