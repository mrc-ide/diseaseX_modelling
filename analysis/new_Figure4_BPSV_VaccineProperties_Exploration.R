...
vaccine_property_scenarios <- rbind(final_bpsv_eff_scenarios, 
                                    final_bpsv_dur_scenarios, 
                                    final_bpsv_eff_inf_scenarios, 
                                    final_bpsv_coverage_scenarios,
...
if (fresh_run) {
  ...
  saveRDS(model_outputs, "outputs/Figure4_BPSVProperties/NEW_BPSV_properties_exploration_scenarios.rds")
} else {
  model_outputs <- readRDS("outputs/Figure4_BPSVProperties/NEW_BPSV_properties_exploration_scenarios.rds")
}
...
## Altogether Plotting
temp2 <- cowplot::plot_grid(bpsv_inf_efficacy_plot, dur_protect_plot,  
                            bpsv_coverage_plot, bpsv_rate_plot, nrow = 2, ncol = 2, labels = c("B", "C", "D", "E"))
overall2 <- cowplot::plot_grid(disease_efficacy_plot2, temp2, ncol = 2, rel_widths = c(0.66, 1), labels = c("A", ""))
ggsave(filename = "figures/Figure_4_BPSVProperties/NEW_Figure4_BPSVProperties_Exploration.pdf",
       plot = overall2,
       height = 7,
       width = 12.5)
