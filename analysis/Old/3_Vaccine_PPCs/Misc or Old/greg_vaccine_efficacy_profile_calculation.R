...
### Note: much of this code is taken from: https://github.com/mrc-ide/global-lmic-reports-orderly/blob/minimal_fitting/src/parameters_vaccines/script.R
set.seed(1000101)
n_samples <- 50
##Set-up VEs for Vaccine Types
ves_by_type <- read_csv("3_Vaccine_PPCs/vaccine_efficacy_groups.csv") %>%
