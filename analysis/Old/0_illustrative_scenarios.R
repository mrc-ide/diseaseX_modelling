...
baseline_scenarios <- create_scenarios(R0 = 2.5,                                      # Basic reproduction number
                                       IFR = 1,                                       # IFR
...
NPIs <- default_NPI_scenarios(lockdown_Rt = lockdown_Rt, minimal_mandate_reduction = minimal_mandate_reduction, NPI_scenarios = 1:9, scenarios = baseline_scenarios)
...
vars_for_index <- c(variable_columns(baseline_scenarios), "NPI_int")
scenarios <- scenarios %>%
