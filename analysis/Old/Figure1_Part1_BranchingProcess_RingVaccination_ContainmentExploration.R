...
if (fresh_run_R0_sensitivity_analysis) {
  ...
  saveRDS(object = overall_bp_df, file = "outputs/Figure1_branchingProcess_Containment/Fig1BC_branchingProcess_ringVaccination_R0Scan.rds")
} else {
  overall_bp_df <- readRDS("outputs/Figure1_branchingProcess_Containment/Fig1BC_branchingProcess_ringVaccination_R0Scan.rds")
}
