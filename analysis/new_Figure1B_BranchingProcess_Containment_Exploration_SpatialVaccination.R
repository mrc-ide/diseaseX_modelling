...
if (fresh_run_R0_sensitivity_analysis) {
  ...
  saveRDS(object = overall_bp_df, file = "outputs/Figure1_branchingProcess_Containment/NEW_branchingProcess_R0_Scan_SpatialVaccination.rds")
} else {
  overall_bp_df <- readRDS("outputs/Figure1_branchingProcess_Containment/NEW_branchingProcess_R0_Scan_SpatialVaccination.rds")
}
