...
default_NPI_scenarios_secondary <- function(lockdown_Rt = 0.9,
  ...
  for (i in 1:nrow(scenarios)) {
    ...
    ## BPSV campaign and specific vaccine development (i.e. following pathogen detection in source country) starts AFTER pathogen arrival in secondary country
  ...
  ## Timings when pathogen arrives in secondary country BEFORE detection in the source country i.e. detection in origin country happens AFTER the arrival of the pathogen in the secondary country
  ## - secondary country detection is the trigger for NPI imposition
