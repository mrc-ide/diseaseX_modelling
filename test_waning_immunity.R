...
x <- run_booster(# Misc Params
  ...
  dur_R = 365000000,
  # dur_V = c(50, 50, 365000000, 365000000),
  dur_V = matrix(c(rep(3650000000, 17),
                   rep(10, 17),
                   rep(10, 17),
                   rep(3650000000, 17)), nrow = 4, ncol = 17, byrow = TRUE),
...
colnames(x$output)[grep("booster_waning_check|primary_waning_check", colnames(x$output))][c(17, 34, 51, 68, 85, 102)]

temp <- cbind(x$output[, "time", 1], x$output[, grep("booster_waning_check|primary_waning_check", colnames(x$output))[c(17, 34, 51, 68, 85, 102)], 1])
